...
class DestinationTest {
    ...
    @Test
    void addActivity() {
        assertEquals(beach.getActivityList(), List.of(swimming));
    }

    @Test
    void testAddActivity() {
        beach.addActivity(List.of(playing,cooking));
        assertEquals(beach.getActivityList(),List.of(swimming,playing,cooking));
